...
CREATE TABLE IF NOT EXISTS "marcas" (
	...
	"cochesnetid" integer PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS "modelos" (
	...
	"cochesnetmodeloid" integer PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS "saved_search" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "saved_search_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"user_id" varchar(255) NOT NULL,
	"name" varchar(255),
	...
	"search_text" text,
	"brand_param" varchar(255),
	"model_param" varchar(255),
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "modelos" ADD CONSTRAINT "modelos_cochesnetmarcaid_marcas_cochesnetid_fk" FOREIGN KEY ("cochesnetmarcaid") REFERENCES "public"."marcas"("cochesnetid") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "saved_search" ADD CONSTRAINT "saved_search_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "saved_search_user_id_idx" ON "saved_search" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "saved_search_name_idx" ON "saved_search" USING btree ("name");--> statement-breakpoint
